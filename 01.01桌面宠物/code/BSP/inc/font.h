...
extern const Image Q1Img;    //默认
extern const Image WX1Img ;  //微笑
extern const Image KQ1Img;   //哭泣
extern const Image YY1Img ;  //语音
extern const Image XM1Img;     //休眠1
extern const Image JTImg ;         //眯眼
