...
void LED3_ON(void)
{
	GPIO_ResetBits(GPIOB, GPIO_Pin_8);		//设置PA2引脚为低电平
}
...
void LED3_OFF(void)
{
	GPIO_SetBits(GPIOB, GPIO_Pin_8);		//设置PA2引脚为高电平
}
...
void LED3_Turn(void)
{
	if (GPIO_ReadOutputDataBit(GPIOB, GPIO_Pin_8) == 0)		//获取输出寄存器的状态，如果当前引脚输出低电平
	{                                                  
		GPIO_SetBits(GPIOB, GPIO_Pin_8);               		//则设置PA2引脚为高电平
	}                                                  
	else                                               		//否则，即当前引脚输出高电平
	{                                                  
		GPIO_ResetBits(GPIOB, GPIO_Pin_8);             		//则设置PA2引脚为低电平
	}
}
/**
  * 函    数：LED4开启
...
void LED4_ON(void)
{
	GPIO_ResetBits(GPIOB, GPIO_Pin_9);		//设置PA2引脚为低电平
}
...
void LED4_OFF(void)
{
	GPIO_SetBits(GPIOB, GPIO_Pin_9);		//设置PA2引脚为高电平
}
...
void LED4_Turn(void)
{
	...
	{                                                  
		GPIO_SetBits(GPIOB, GPIO_Pin_9);               		//则设置PA2引脚为高电平
	}                                                  
	else                                               		//否则，即当前引脚输出高电平
	{                                                  
		GPIO_ResetBits(GPIOB, GPIO_Pin_9);             		//则设置PA2引脚为低电平
	}
}
